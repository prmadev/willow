    ...
    programs.helix = {
      ...
      themes = {
        rp = {
          ...
          "operator" = { fg = config.colors.gold.hex; modifiers = [ "bold" ]; };
          "punctuation" = { fg = config.colors.gold.hex; modifiers = [ "bold" ]; };
          ...
          "error" = { fg = config.colors.love.hex; bg = config.colors.surface.hex; };
