    ...
    programs.helix = {
      ...
      themes = {
        rp = {
          ...
          # gutter:
          "info" = { fg = config.colors.base.hex; bg = config.colors.pine.hex; };
          "hint" = { fg = config.colors.base.hex; bg = config.colors.foam.hex; };
          "warning" = { fg = config.colors.base.hex; bg = config.colors.gold.hex; };
          "error" = {
            fg = config.colors.base.hex;
