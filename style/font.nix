  ...
  options = {
    global-fonts = {
      ...
      main-italic = mkOption {
        type = types.str;
        default = "LigaOperatorMono Italic Nerd Font";
      };
      ...
      main-set = mkOption {
        ...
        default = ["LigaOperatorMono Nerd Font" "Dana" "ComicCodeLigatures Nerd Font" "ComicCodeLigatures Nerd Font Complete Mono" "Gintronic" "Vazirmatn"];
      };
    };
  };
}
